...
public class VideoReader {
	...
	public ArrayList<javafx.scene.paint.Color> averageColorList; // array of the average color (hex) of the frames
	...
	public VideoReader(String videPath, String imagePath) {
		...
		averageColorList = new ArrayList<javafx.scene.paint.Color>();
		numFrames = 0;
	}
	 ...
	 */
	public ArrayList<javafx.scene.paint.Color> videoToImg(String imgType, int frameJump) throws Exception, IOException {
