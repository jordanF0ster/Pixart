...
public class ImageReader {
	 ...
	 */
	public javafx.scene.paint.Color averagePixelValue() {
		int redTotal = 0, greenTotal = 0, blueTotal = 0, aTotal = 0;
		int avgRedTotal = 0, avgGreenTotal = 0, avgBlueTotal = 0, avgATotal = 0;
		double opacity;
		...
		avgATotal = aTotal / area;
				
		opacity = avgATotal / 255.0;
		javafx.scene.paint.Color fxColor = javafx.scene.paint.Color.rgb(avgRedTotal, avgGreenTotal, avgBlueTotal, opacity);
		return fxColor;
	}
